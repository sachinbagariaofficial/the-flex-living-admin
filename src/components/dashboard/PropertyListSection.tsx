    ...
    <>
      ...
      <div className="flex justify-end items-center gap-2 mb-4">
        ...
        <select
          ...
          className="rounded-lg border border-slate-200 bg-white text-sm text-slate-900 py-1 px-2 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition-all duration-200"
        >
